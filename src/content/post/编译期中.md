...
$\quad$ $\quad$ $\quad$ 对每个i从1到n，对于每个j从1到i-1，将形如$A_i \rightarrow A_jr$的规则替换为 $A_i \rightarrow \sigma_1 r | \sigma_2 r... | \sigma_k r$ ,$A_j \rightarrow \sigma_1 | \sigma_2 ... \sigma_k 是当前A_j的$所有产生式。最后，消除所有直接左递归
...
~~~
补充：其实就是I0包含所有·在最左边的，然后依次按照·要经过的来分
~~~
###### 计算closure
